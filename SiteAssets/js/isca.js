...
function createViz(error, componentsData) {
    ...
    var data = componentsData.value.filter(function(d) {
        // Id,Component,InvestmentNumber,Category,InvestmentName,Year,Total
    ...
    var
        ...
        // amountByComponent = categoryDim.group().reduceSum(function(d) {
        //     return Math.round(d.Total);
        // }),
        amountByComponent = categoryDim.group().reduce(
            function(p, v) {
                ++p.count;
    ...
    compositionbubbleChart
        ...
        .x(d3.scale.linear().domain([0,100000000]))
        ...
        compositionbubbleChart
        .yAxisLabel("Number of Investments per Cateogry")
