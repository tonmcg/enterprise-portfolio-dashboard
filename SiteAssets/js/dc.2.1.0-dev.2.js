...
(function() {
    function _dc(d3, crossfilter) {
        ...
        //https://github.com/mtraynham/dc.js/blob/4333ffdd41fcef1baf97d60c7b1dae0df5d1509f/src/tree-map.js
        ...
        dc.treeMap = function(parent, chartGroup) {
            var _chart = dc.capMixin(dc.colorMixin(dc.marginMixin(dc.baseMixin({}))));
            ...
            var _treeMap = d3.layout.treemap()
                ...
                }) // Return d.values from d3.nest
                .sort(function(a, b) {
                    return a._value - b._value;
                }) // Return computed level value
            ...
            // Options
            var _rootName = 'Department of Justice Investment Service Category Apportionment',
                _mode = 'squarify',
            ...
            function selectionSize(x, y, gap) {
                ...
                return function() {
                    this.attr('width', function(d) {
                            return Math.max(0, x(d.x + d.dx) - x(d.x) - gap / 2);
                        })
                        .attr('height', function(d) {
                            return Math.max(0, y(d.y + d.dy) - y(d.y) - gap / 2);
                        });
                };
            }
            ...
            function drawNode(node) {
                ...
                var children = tree.selectAll('g')
                    .data(node.values, function(d) {
                        return d.depth + d.key;
                    });
            ...
            function createFilter(node) {
                return node.parent ?
                    createFilter(node.parent).concat([node.key]) : [node.key];
            }
